        ...
        <div className="h-screen w-screen flex justify-center items-center" style={{background: "linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url('https://images.pexels.com/photos/6984661/pexels-photo-6984661.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') center", backgroundSize: "cover"}}>
            <div className="w-2/5 p-4 bg-white flex flex-wrap">
                ...
                <div className="flex flex-wrap justify-center">
                    <input className="flex-1 p-2 m-2 border border-black border-solid" placeholder="name"></input>
                    <input className="flex-1 p-2 m-2 border border-black border-solid" placeholder="last name"></input>
                    <input className="flex-1 p-2 m-2 border border-black border-solid" placeholder="username"></input>
                    <input className="flex-1 p-2 m-2 border border-black border-solid" placeholder="email"></input>
                    <input className="flex-1 p-2 m-2 border border-black border-solid" placeholder="password"></input>
                    <input className="flex-1 p-2 m-2 border border-black border-solid" placeholder="confirm password"></input>
